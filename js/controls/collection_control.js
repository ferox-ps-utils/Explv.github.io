...
export var CollectionControl = L.Control.extend({    
    ...
    onAdd: function (map) {
        ...
        // Area control
        this._createControl('<img src="./public/css/images/area-icon.png" alt="Area" title="Area" height="30" width="30">', container, function(e) {
            this._toggleCollectionMode(this._areas, "areas_converter", e.target);
        });        

        // Poly Area control
        this._createControl('<img src="./public/css/images/polyarea-icon.png" alt="Poly Area" title="Poly Area" height="30" width="30">', container, function(e) {
            this._toggleCollectionMode(this._polyArea, "polyarea_converter", e.target);
        });

        // Path control
        this._createControl('<img src="./public/css/images/path-icon.png" alt="Path" title="Path" height="30" width="30">', container, function(e) {
            this._toggleCollectionMode(this._path, "path_converter", e.target);
        });

        // Dax Path control
        this._createControl('<img src="./public/css/images/dax-path-icon.png" alt="Dax Path" title="Dax Path" height="25" width="30">', container, function(e) {
